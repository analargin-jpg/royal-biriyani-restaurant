...
export default function HeroSection({ onOpenBulk, onScrollMenu }) {
  return (
    <section className="relative overflow-hidden bg-royal-crimson text-white">
      ...
      {/* Rising Firewood Embers Animation */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute left-[15%] bottom-10 w-2 h-2 rounded-full bg-amber-400 blur-2xs animate-ember-1" />
        <div className="absolute left-[35%] bottom-16 w-2.5 h-2.5 rounded-full bg-yellow-300 blur-2xs animate-ember-2" />
        <div className="absolute left-[70%] bottom-8 w-2 h-2 rounded-full bg-amber-500 blur-2xs animate-ember-3" />
        <div className="absolute left-[85%] bottom-20 w-1.5 h-1.5 rounded-full bg-yellow-400 blur-2xs animate-ember-1" />
      </div>
      ...
      <div className="relative max-w-6xl mx-auto px-4 py-12 sm:py-20 md:py-24 flex flex-col items-center text-center">
        ...
        <h1 className="text-3xl sm:text-5xl md:text-6xl font-black tracking-tight max-w-4xl leading-tight mb-3 sm:mb-4">
          <span className="animate-gradient-text drop-shadow-md">Royal Biriyani &amp; Fast Food</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto mb-10 sm:mb-12">
          <button
            ...
            className="w-full sm:w-auto px-7 py-3.5 sm:py-4 bg-white text-royal-crimson hover:bg-gray-100 font-black text-sm sm:text-base rounded-2xl shadow-xl hover:shadow-2xl transition transform hover:-translate-y-1 flex items-center justify-center gap-2 active:scale-95 cursor-pointer"
          >
          ...
          <a
            ...
            className="w-full sm:w-auto px-5 py-3.5 sm:py-4 bg-black/30 hover:bg-black/40 text-white font-bold text-sm sm:text-base rounded-2xl border border-white/20 transition transform hover:-translate-y-1 flex items-center justify-center gap-2 active:scale-95"
          >
        ...
        {/* Key Features Ribbon with Card Shine & Hover Lift */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2.5 sm:gap-4 w-full max-w-4xl text-left">
          <div className="card-shine bg-black/25 backdrop-blur-sm border border-white/10 p-3 sm:p-3.5 rounded-2xl flex items-center gap-2.5 sm:gap-3 hover:-translate-y-1 hover:border-amber-400/40 hover:shadow-xl transition-all duration-300">
            <Award className="w-6 h-6 sm:w-8 sm:h-8 text-royal-gold flex-shrink-0 animate-bounce-gentle" />
            <div>
          ...
          <div className="card-shine bg-black/25 backdrop-blur-sm border border-white/10 p-3 sm:p-3.5 rounded-2xl flex items-center gap-2.5 sm:gap-3 hover:-translate-y-1 hover:border-emerald-400/40 hover:shadow-xl transition-all duration-300">
            <CheckCircle2 className="w-6 h-6 sm:w-8 sm:h-8 text-emerald-400 flex-shrink-0 animate-pulse" />
            <div>
          ...
          <div className="card-shine bg-black/25 backdrop-blur-sm border border-white/10 p-3 sm:p-3.5 rounded-2xl flex items-center gap-2.5 sm:gap-3 hover:-translate-y-1 hover:border-amber-400/40 hover:shadow-xl transition-all duration-300">
            <Sparkles className="w-6 h-6 sm:w-8 sm:h-8 text-royal-gold flex-shrink-0 animate-spin-slow" />
            <div>
          ...
          <div className="card-shine bg-black/25 backdrop-blur-sm border border-white/10 p-3 sm:p-3.5 rounded-2xl flex items-center gap-2.5 sm:gap-3 hover:-translate-y-1 hover:border-amber-300/40 hover:shadow-xl transition-all duration-300">
            <Clock className="w-6 h-6 sm:w-8 sm:h-8 text-amber-300 flex-shrink-0 animate-bounce-gentle" />
            <div>
