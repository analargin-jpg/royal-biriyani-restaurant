      ...
      <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-gray-200/80 shadow-xs transition-all">
        ...
        <div className="bg-gradient-to-r from-royal-crimson via-royal-crimson-dark to-royal-crimson text-white text-[11px] sm:text-xs py-1.5 px-3 sm:px-4">
          <div className="max-w-6xl mx-auto flex justify-between items-center">
            <div className="flex items-center gap-2 font-medium">
              ...
              <span className="truncate">Now Open &amp; Delivering Wood-Fired Biriyani in Komarapalayam!</span>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-3 sm:px-4 py-2.5 sm:py-3 flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-2.5 sm:gap-3 group">
            <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-2xl bg-gradient-to-br from-royal-crimson to-royal-crimson-dark flex items-center justify-center text-royal-gold shadow-md group-hover:scale-105 transition transform border border-amber-300/30">
              <Utensils className="w-5 h-5 sm:w-6 sm:h-6" />
            </div>
            <div>
              <div className="flex items-center gap-1.5">
                <h1 className="font-black text-lg sm:text-xl leading-none text-royal-crimson tracking-tight">
                  Royal Biriyani
                </h1>
                <span className="hidden xs:inline-block text-[10px] font-black bg-amber-100 text-amber-900 px-1.5 py-0.5 rounded-md border border-amber-300 uppercase">
                  Fast Food
                </span>
              </div>
              <p className="text-[10px] sm:text-xs text-gray-500 font-medium">Authentic South Indian • Salem Main Rd</p>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {currentUser ? (
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-1.5 py-1.5 px-2.5 sm:px-3 rounded-xl bg-amber-50 hover:bg-amber-100 border border-amber-200 text-royal-charcoal text-xs font-bold transition shadow-xs"
                >
                  ...
                  <span className="max-w-[80px] sm:max-w-[100px] truncate hidden sm:inline">{currentUser.name.split(' ')[0]}</span>
                ...
                {userDropdownOpen && (
                  ...
                  >
                    <div className="px-4 py-2 border-b border-gray-100">
                      ...
                      <p className="text-[10px] text-gray-500">{currentUser.phone}</p>
                    </div>
                    <button
              ...
              <button
                onClick={onOpenAuth}
                className="hidden sm:inline-flex items-center gap-1.5 py-2 px-3 rounded-xl bg-amber-50 hover:bg-amber-100 border border-amber-200 text-royal-crimson font-extrabold text-xs transition shadow-xs"
              >
                <LogIn className="w-3.5 h-3.5 text-royal-crimson" /> Sign In
              </button>
            )}
            ...
            <button
              onClick={onOpenCart}
              className="relative p-2.5 rounded-xl bg-gray-100 hover:bg-red-50 text-gray-800 hover:text-royal-crimson transition shadow-inner flex items-center justify-center active:scale-95"
            ...
            <button
              ...
              className="md:hidden p-2 rounded-xl text-gray-700 hover:bg-gray-100 focus:outline-none transition active:scale-90"
